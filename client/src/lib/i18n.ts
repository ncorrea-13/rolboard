...
const dict = {
  es: {
    ...
    "campaignSettings.accessCodeTitle": "Código de acceso para jugadores",
    "campaignSettings.accessCodePlaceholder": "Nuevo código",
  ...
  en: {
    ...
    "campaignSettings.accessCodeTitle": "Player access code",
    "campaignSettings.accessCodePlaceholder": "New code",
